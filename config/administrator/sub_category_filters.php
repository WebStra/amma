...
return [
    ...
    'description' => 'Filters for subcategories.',
    ...
    */
    'query' => function ($query) {
        return $query->where('filterable_type', SubCategory::class);
    },
    ...
    'filters' => [
        ...
        'group' => filter_select('Group', function(){
            ...
            $groups = CategoryFilter::select('group')
                ->where('filterable_type', SubCategory::class)
                ->pluck('group')
                ->toArray();
    ...
    */
    'edit_fields' => [
        ...
        'filterable_type' => [
            'type' => 'hidden',
            'value' => SubCategory::class
        ],

        'filterable_id' => form_select('Choose category', function () {
            $items = [];

            $categories = SubCategory::select('*')->active()->get();
