        ...
        <div class="container">
            <div class="row">
                        ...
                        <div id="slider" class="flexslider">
                            <div class="flex-viewport">
                                <ul class="slides simpleLens">
                                        ...
                                        <li>
                                          <img src="/assets/images/product1.jpg" data-imagezoom="true" data-magnification="3"/>
                                        </li>
                                        <li>
                                          <img src="/assets/images/product1.jpg" data-imagezoom="true" data-magnification="3"/>
                                        </li>
                ...
                <div class="col l5 m6 s12 product_info form">
                    ...
                    <div class="row">
                        <div class="col s12">
                            <ul class="tabs" style="width: 100%;">
                                <li class="tab" style="width: 50%;"><a class="active cursor-default" href="#about_product">DESPRE PRODUS</a></li>
                    ...
                    <div class="row">
                        <div class="col s12">
                            <p>Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Nulla quis lorem ut libero malesuada feugiat. Pellentesque in ipsum id orci porta dapibus. Praesent sapien massa, convallis a pellentesque nec, egestas non nisi. Nulla porttitor accumsan tincidunt. Praesent sapien massa, convallis a pellentesque nec, egestas non nisi. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec velit neque, auctor sit amet aliquam vel, ullamcorper sit amet ligula. Sed porttitor lectus nibh. Nulla quis lorem ut libero malesuada feugiat. Quisque velit nisi, pretium ut lacinia in, elementum id enim.</p>
                        </div>
                    </div>
                    <ul class="social">
                        <li>
                            <a href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Famma%2Fro%2Fproduct%2F247&amp;title=Desperado%20Jeans%20%28M%2C%20S%2C%20XXL%29%20Summer%202016%20July" onclick="window.open(this.href,'targetWindow','menubar=no,scrollbars=yes,resizable=yes,width=660,height=600');return false;" class="icon-facebook">
                            </a>
                        </li>
                        <li>
                            <a href="https://connect.ok.ru/offer?url=http%3A%2F%2Famma%2Fro%2Fproduct%2F247&amp;title=Desperado%20Jeans%20%28M%2C%20S%2C%20XXL%29%20Summer%202016%20July" onclick="window.open(this.href,'targetWindow','menubar=no,scrollbars=yes,resizable=yes,width=660,height=600');return false;" class="icon-odnoklassniki">
                            </a>
                        </li>
                        <li>
                            <a href="https://plus.google.com/share?url=http%3A%2F%2Famma%2Fro%2Fproduct%2F247" onclick="window.open(this.href,'targetWindow','menubar=no,scrollbars=yes,resizable=yes,width=660,height=600');return false;" class="icon-google-plus">
                            </a>
                        </li>
                        <li>
                            <a href="https://twitter.com/intent/tweet?url=http%3A%2F%2Famma%2Fro%2Fproduct%2F247&amp;text=Desperado%20Jeans%20%28M%2C%20S%2C%20XXL%29%20Summer%202016%20July" onclick="window.open(this.href,'targetWindow','menubar=no,scrollbars=yes,resizable=yes,width=660,height=600');return false;" class="icon-twitter">
                            </a>
                        </li>
                        <li>
                            <a href="http://vk.com/share.php?url=http%3A%2F%2Famma%2Fro%2Fproduct%2F247&amp;title=Desperado%20Jeans%20%28M%2C%20S%2C%20XXL%29%20Summer%202016%20July&amp;image=%2Fupload%2Fproducts%2F247%5C1468248814_4cac34f5cc6e5f5ca2498087707ca8b5.jpg&amp;noparse=false" onclick="window.open(this.href,'targetWindow','menubar=no,scrollbars=yes,resizable=yes,width=660,height=600');return false;" class="icon-vkontakte">
                            </a>
                        </li>
                    </ul>
                </div>
                                    ...
                                    <div class="content_tab">
                                        <div class=" display-table authentification">
                                            <div class="td">
                                                ...
                                                <form action="http://amma/ro/login" class="form styled3" method="post">
                                                    <div class="col s12">
                                                        <div class="input-field">
                                                    ...
                                                    <div class="col s12">
                                                        ...
                                                        <div class="input-field">
                                                            <a href="http://amma/ro/social/login/facebook" class="btn btn_facebook full_width">
                                                    ...
                                                    <input type="hidden" name="_token" value="nEm0PWfPxgvNEqDcwyUqyYbAm2NKhhSSMyEXUNY6">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="register" class="col s12 tab_content" style="display: none;">
                                <div class="row">
                                    ...
                                    <form action="http://amma/ro/register" class="form styled3" method="post">
                                        <div class="col s12">
                                            <div class="input-field">
                                                <input type="text" name="firstname" required="" placeholder="Firstname" value="">
                                            </div>
                                        </div>
                                        <div class="col s12">
                                            <div class="input-field">
                                                <input type="text" name="lastname" required="" placeholder="Lastname" value="">
                                            </div>
                                        </div>
                                        <div class="col s12">
                                            <div class="input-field">
                                                <input type="email" name="email" required="" placeholder="Ex: maria@gmail.com" value="">
                                            </div>
                                        </div>
                                        <div class="col s12">
                                            <div class="input-field">
                                                <input type="text" name="phone" required="" placeholder="+373 777 77 777" value="">
                                            </div>
                                        </div>
                                        <div class="col s12">
                                            <div class="input-field">
                                        ...
                                        <div class="col s12">
                                            ...
                                            <p class="center">Ai deja un cont? <a href="http://amma/ro/login" class="c_base">Intră în cont</a></p>
                                        </div>
                                        <input type="hidden" name="_token" value="nEm0PWfPxgvNEqDcwyUqyYbAm2NKhhSSMyEXUNY6">
                                    </form>
                                </div>
