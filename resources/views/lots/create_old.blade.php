                    ...
                    <form method="post" action="{{ route('create_lot', [ 'lot' => $lot->id ]) }}" id="create_form_lot" onsubmit="createLot(this)" class="form form-lot"
                        ...
                        <div class="col l6 m6 s12">
                            <div class="input-field">
                                ...
                                <input type="text" class="input-amount" required="" name="yield_amount" value="{{ old('yield_amount') ? old('yield_amount') : $lot->yield_amount }}"
                                       placeholder="0.00">
                                <span class="comision"><i>Comision: <span class="comision-val">{{$lot->comision}}</span></i></span>
                                @if(count($currencies))
                        ...
                        <div class="col l6 m6 s12">
                            ...
                            <div class="input-field">
                                ...
                                <textarea name="description_delivery">{{ old('description_delivery') ? old('description_delivery') : $lot->description_delivery }}</textarea>
                            </div>
                        </div>
                        <div class="col l6 m6 s12">
                            ...
                            <div class="input-field">
                                ...
                                <textarea name="description_payment">{{ old('description_payment') ? old('description_payment') : $lot->description_payment }}</textarea>
                            </div>
                        </div>
