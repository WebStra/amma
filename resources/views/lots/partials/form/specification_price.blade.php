<div class="specification_price_item overflow {{ isset($spec) ? 'saved' : '' }}" data-spec-id="{{ isset($spec) ? $spec->id : '' }}" data-suite-spec="{{ isset($key_spec) ? $key_spec : 1 }}" data-product="{{ $product->id }}">
    ...
    <div class="col l12 s12">
        <div class="input-field">
            ...
            <input type="text" required name="spec_price[{{ isset($key_spec) ? $key_spec : 1 }}][name]"
    ...
    <div class="col l4 s12">
        <div class="input-field">
            ...
            <input type="text" class="old_price" name="spec_price[{{ isset($key_spec) ? $key_spec : 1 }}][old_price]"
    ...
    <div class="col l4 s12 ">
        <div class="input-field">
            ...
            <input type="text" class="new_price" name="spec_price[{{ isset($key_spec) ? $key_spec : 1 }}][new_price]"
    ...
    <div class="col l4 s12">
        <div class="input-field">
            ...
            <input type="text" class="create_sale" name="spec_price[{{ isset($key_spec) ? $key_spec : 1 }}][sale]" placeholder="0%"
