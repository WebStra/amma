    ...
    <div class="top_bar">
        <div class="container cf">
            ...
            <div class="right top-bar-langs">
                <a href='#' data-activates='dropdown_top-bar-langs' class="dropdown_top_bar"><i class="icon-ro"></i> Romana <i class="icon-la-down"></i></a>
                <ul id='dropdown_top-bar-langs' class='dropdown-content'>
                    <li><a href="#!"><i class="icon-ru"></i> Rusa</a></li>
                    <li><a href="#!"><i class="icon-gb"></i> English </a></li>
                </ul>
            </div>
        ...
        <div class="container">
                ...
                <nav class="navbar">
                    <div class="nav-wrapper">
                        ...
                        <ul class="left nav_wide hide-on-med-and-down">
                            ...
                            <li> <a href='#'><span class="wrapp_badge">OFERTE CARE EXPIRĂ <span class="badge_top">New</span></span> </a> </li>
            ...
            <div class="top_categories row cf">
                <div class="col l3 m3 s12 wrapp_categories">
                    <a href='#' data-activates='dropdown_all_categories' class="navbar_dropdown"><i class="icon-grid-line"></i> Categorii</a>
                ...
                <div class="col l9 m9 s12">
                    <form class="top_search cf">
                        ...
                        <div class="wrapp_submit">
                            <button type="submit"><i class="icon-search"></i><span class="hide_767_down">Cauta</span></button>
                        </div>
                    </form>
                </div>
            </div>
