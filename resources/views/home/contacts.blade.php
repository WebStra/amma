        ...
        <div class="col l6 m12 s12">
          ...
          <ul class="contacts">
            ...
            <li>
              ...
              <p><strong class="small">Directorul Executiv /</strong><span class="c_base">{{ settings()->getOption('contact_info::executivPhone') }}</span></p>
              <p><strong class="small">Departamentul de vânzări /</strong><span class="c_base">{{ settings()->getOption('contact_info::sellPhone') }}</span></p>
              <p><strong class="small">Departamentul tehnic /</strong><span class="c_base">{{ settings()->getOption('contact_info::tehnicPhone') }}</span></p>
            </li>
          </ul>
        </div>
        <div class="col l6 m12 s12">
            ...
            <form class="form styled2 row" action="{{ route('send_form') }}" method="POST">
              ...
              <div class="col s12">
                <div class="input-field">
                  <input type="text" name="name" placeholder="Numele prenumele" value="{{ old('name') ? : ((Auth::check()) ? Auth::user()->present()->renderName() : '') }}">
                  @include('partials.errors.error-field', ['field' => 'name'])
                </div>
              </div>
              <div class="col s12">
                <div class="input-field">
                  <input type="email" name="email" placeholder="Adresa electronica" value="{{ old('email') ? : ((Auth::check()) ? Auth::user()->email : '') }}">
              ...
              <div class="col s12">
                ...
                <div class="inline-inputs">
                  <input type="text" name="phone" placeholder="Telefon" value="{{ old('phone') ? : ((Auth::check()) ? Auth::user()->profile->phone : '') }}">
